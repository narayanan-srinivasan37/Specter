...
data+="<ID>Ledger</ID></HEADER><BODY><DESC><STATICVARIABLES><SVEXPORTFORMAT>$$SysName:XML</SVEXPORTFORMAT>"
...
data+="<NATIVEMETHOD>PARTYGSTIN</NATIVEMETHOD></COLLECTION></TDLMESSAGE></TDL></DESC></BODY></ENVELOPE>"
...
#print(ledgerdetails)
fields=["NAME","PARENT", "Mobile no", "State ", "Country","Address","Pincode","GSTIN","Credit Perios"]
